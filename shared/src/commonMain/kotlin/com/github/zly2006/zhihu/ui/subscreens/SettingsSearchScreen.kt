...
private val settingsSearchEntries = buildList {
    ...
    add(appearanceEntry("appearance.bottomSheetCorners", "使用 popup 圆角", "开启后评论等 popup 顶部显示圆角。", USE_BOTTOM_SHEET_ROUNDED_CORNERS_PREFERENCE_KEY, listOf("评论圆角", "popup", "圆角")))
